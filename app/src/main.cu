...
int main(int argc, char* argv[]) {
	...
	/**		Shapes		**/
	//manager.addCube("cube1", Vertex(0, 0, 0), 10, nullptr);
	...
	/*manager.imprtShapeObj("OBJ/Earth/", "Earth.obj", "earth3", 0.001);
	manager.getShape("earth3").move(Vector(0, 0, -25));
	manager.imprtShapeObj("OBJ/Earth/", "Earth.obj", "earth4", 0.001);
	manager.getShape("earth4").move(Vector(0, 0, -25));
	manager.imprtShapeObj("OBJ/Earth/", "Earth.obj", "earth5", 0.001);
	manager.getShape("earth5").move(Vector(0, 0, -25));
	manager.imprtShapeObj("OBJ/Earth/", "Earth.obj", "earth6", 0.001);
	manager.getShape("earth6").move(Vector(0, 0, -25));
	manager.imprtShapeObj("OBJ/Earth/", "Earth.obj", "earth7", 0.001);
	manager.getShape("earth7").move(Vector(0, 0, -25));
	manager.imprtShapeObj("OBJ/Earth/", "Earth.obj", "earth8", 0.001);
	manager.getShape("earth8").move(Vector(0, 0, -25));
	manager.imprtShapeObj("OBJ/Earth/", "Earth.obj", "earth9", 0.001);
	manager.getShape("earth9").move(Vector(0, 0, -25));
	manager.imprtShapeObj("OBJ/Earth/", "Earth.obj", "earth10", 0.001);
	manager.getShape("earth10").move(Vector(0, 0, -25));
	manager.imprtShapeObj("OBJ/Earth/", "Earth.obj", "earth11", 0.001);
	manager.getShape("earth11").move(Vector(0, 0, -25));
	manager.imprtShapeObj("OBJ/Earth/", "Earth.obj", "earth12", 0.001);
	manager.getShape("earth12").move(Vector(0, 0, -25));*/
