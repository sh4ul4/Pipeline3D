...
public:
	Cube(const std::string& name, const Vertex& center, const double& width, Bitmap* bmp) :Shape(name, {}, center, bmp), width(width) {
		...
		// set 12 triangles
		triangles.push_back(Triangle(a, b, d, { 0,0,0 }, blue, bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = blue; triangles.back().fillIt(true);
		triangles.push_back(Triangle(c,b,d, { 0,0,0 }, blue,bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = red; triangles.back().fillIt(true);
		triangles.push_back(Triangle(b,g,c, { 0,0,0 }, blue,bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = green; triangles.back().fillIt(true);
		triangles.push_back(Triangle(b,g,f, { 0,0,0 }, blue,bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = white; triangles.back().fillIt(true);
		triangles.push_back(Triangle(d,g,c, { 0,0,0 }, blue,bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = black; triangles.back().fillIt(true);
		triangles.push_back(Triangle(d,g,h, { 0,0,0 }, blue,bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = yellow; triangles.back().fillIt(true);
		triangles.push_back(Triangle(e,g,h, { 0,0,0 }, blue,bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = cyan; triangles.back().fillIt(true);
		triangles.push_back(Triangle(e,g,f, { 0,0,0 }, blue,bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = gray; triangles.back().fillIt(true);
		triangles.push_back(Triangle(a,h,d, { 0,0,0 }, blue,bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = dark_gray; triangles.back().fillIt(true);
		triangles.push_back(Triangle(a,h,e, { 0,0,0 }, blue, bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = lime; triangles.back().fillIt(true);
		triangles.push_back(Triangle(a,f,e, { 0,0,0 }, blue, bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
		triangles.back().color = maroon; triangles.back().fillIt(true);
		triangles.push_back(Triangle(a,f,b, { 0,0,0 }, blue, bmp, { 0,bmp->surface->h }, { bmp->surface->w,0 }, { 0,bmp->surface->h }));
...
public:
	Rectangle(const std::string& name, const Vertex& a, const Vertex& b, const Vertex& c, const Vertex& d, Bitmap* bmp = nullptr): Shape(name) {
		if (bmp == nullptr) {
			...
			this->center.z /= 4;
			// set 2 triangles
			triangles.push_back(Triangle(a, b, c, { 0,0,0 }, black, bmp, { 0,bmp->surface->h }, { bmp->surface->w,bmp->surface->h }, { 0,0 }));
			triangles.push_back(Triangle(c, b, d, { 0,0,0 }, black, bmp, { 0,0 } ,{ bmp->surface->w,bmp->surface->h }, { bmp->surface->w,0 }));
